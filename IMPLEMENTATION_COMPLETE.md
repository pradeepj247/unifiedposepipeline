...
**File**: `stage7_create_selection_table.py` (new file)
...
│ - Run: python stage7_select_person.py --person-id <ID>       │
└───────────────────────────────────────────────────────────────┘
    ↓ primary_person.npz
...
├── stage7_create_selection_table.py      # Generate PNG selection table
